...
The Mr. Trash Wheel sheet contains `r nrow(wheel_data)` observations.And it contains variables of month, year, date, weight, volume, plastic bottles, polystyrene, cigarette_butts, glass bottles, grocery bags, chip bags, sports balls and homes powered. 

The precipitation dataset contains `r nrow(precipitation_data)` observations. And it contains variables of year, month and the total precipitaion. 
