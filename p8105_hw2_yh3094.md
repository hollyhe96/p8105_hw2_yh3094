...
The Mr. Trash Wheel sheet contains 216 observations.And it contains variables of month, year, date, weight, volume, plastic bottles, polystyrene, cigarette\_butts, glass bottles, grocery bags, chip bags, sports balls and homes powered.

The precipitation dataset contains 20 observations. And it contains variables of year, month and the total precipitaion.
